...
Note: Make sure you install the `hclust` package in R.
...
# this part is commented out as the factoextra package is not installing properly on Cavatica
...
#fviz_nbclust(scale(mets), FUN = hcut, method = "wss")
...
#fviz_nbclust(scale(mets), FUN = hcut, method = "silhouette")
...
#gap_stat <- clusGap(scale(mets), FUN = hcut, nstart = 25, K.max = 10, B = 50)
